...
TARGET_DIR="$HOME/Documents/Open_stability/html-office/crx/app"  # Specify your target directory path
...
cd "$HOME/Documents/Open_stability/html-office/crx/e2eTests/miscTests/openStabilityTest" || exit 1
...
PROJECT_DIR="$HOME/Documents/Open_stability/html-office/crx/e2eTests/miscTests/openStabilityTest"
...
#Navigating to e2eTests to open it in Terminal
cd "$HOME/Documents/Open_stability/html-office/crx/e2eTests" || { echo "Failed to navigate to next folder"; exit 1; }
